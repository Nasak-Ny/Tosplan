...
<div x-data="{ show: true }" x-init="setTimeout(() => show = false, 3000)"
    ...
    class="absolute z-50 flex items-center py-4 pl-4 pr-16 mb-3 text-black border-4 border-red-500 rounded shadow-2xl bg-red-50 top-24 right-5">

    <svg class="w-12 h-12 mr-6 text-red-600" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 16 12">
