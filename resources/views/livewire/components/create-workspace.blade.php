<div
    x-cloak
    wire:ignore.self
    x-show="createWorkspace"
    @click.away="createWorkspace = false"
    tabindex="-1"
    aria-hidden="true"
        ...
        <div class="w-full pb-2">
            ...
            <div class="flex items-center justify-between w-full px-4 pt-4 mb-6 modal-header cursor-grab">
                ...
                <div class="flex items-center">
                    <button @click="createWorkspace = false" class="p-2.5 mb-3 bg-red-600 rounded-lg hover:bg-red-500 hover:bg-opacity-90">
            ...
            <div class="px-4">
                ...
                <button wire:click="createWorkspace" class="w-full text-white bg-teal-500 hover:bg-teal-600 rounded-lg py-2.5 text-center font-bold text-lg mb-4">
                    Create
                </button>
            </div>
        </div>
