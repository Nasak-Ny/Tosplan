<div
    ...
    wire:ignore.self
    x-show="modifyList"
    @click.away="modifyList = false"
    tabindex="-1"
    aria-hidden="true"
    class="fixed inset-0 z-50 flex items-center justify-center h-screen"
    x-data="{ isDragging: false, offsetLeft: 0, offsetTop: 0, deleteList: false }"
    x-on:closemodel.window="modifyList = false"
...
>
    ...
    >
        <div class="w-full pb-2">
            ...
            <div class="px-4">
                ...
                <button wire:click="modifyList" class="w-full text-white bg-teal-500 hover:bg-teal-600 rounded-lg py-2.5 text-center font-bold text-lg mb-8">
                    Save
                </button>
                <div class="flex items-center justify-end mb-2">
                    <button type="button" @click.prevent="deleteList = !deleteList" class="text-lg font-bold text-red-500 hover:text-red-600">
                        Delete this list
                    </button>
                </div>
            </div>
    ...
    @include('livewire.components.delete-list')
</div>
