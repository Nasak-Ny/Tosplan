            ...
            <div class="w-full">
                ...
                <div class="flex flex-wrap w-full">
                    ...
                    <div class="flex items-center justify-center w-full mb-6 text-lg font-bold">
                        <button wire:click="deleteBoard" class="py-3 w-44 flex items-center justify-center mr-4 text-white bg-[#b82a29] rounded-lg hover:bg-red-600">
                            Yes
                        </button>
                        <button @click="deleteBoard = false" class="py-3 w-44 flex items-center justify-center ml-4 text-[#b82a29] border-2 border-[#b82a29] rounded-lg dark:hover:bg-zinc-800 hover:bg-gray-100">
                            Cancel
                        </button>
                    </div>
                </div>
